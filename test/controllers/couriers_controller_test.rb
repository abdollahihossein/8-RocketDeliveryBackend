...
class CouriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create courier" do
    assert_difference("Courier.count") do
      post couriers_url, params: { courier: { active: @courier.active, email: @courier.email, phone: @courier.phone } }
    end
  ...
  test "should update courier" do
    patch courier_url(@courier), params: { courier: { active: @courier.active, email: @courier.email, phone: @courier.phone } }
